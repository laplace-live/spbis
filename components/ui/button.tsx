...
const buttonVariants = cva(
  'focus-ring inline-flex appearance-none items-center justify-center gap-1 whitespace-nowrap font-medium disabled:cursor-not-allowed disabled:opacity-50',
  {
    ...
    compoundVariants: [
      ...
      // Outline
      { variant: 'outline', tint: 'default', className: 'border-fg/30 not-disabled:hover:bg-fg/5 focus-visible:border-ac focus-visible:ring-ac/30 data-[state=open]:bg-fg/5', },
      ...
      // Ghost
      { variant: 'ghost', tint: 'default', className: 'not-disabled:hover:bg-ac/10 not-disabled:hover:text-ac focus-visible:ring-ac/30 data-[state=open]:bg-ac/10 data-[state=open]:text-ac' },
